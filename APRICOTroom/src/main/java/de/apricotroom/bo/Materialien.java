...
public enum Materialien {
	KEINE_AUSWAHL("Keine Auswahl", "00"), VERGOLDETES_SILBER("Vergoldetes Silber", "01"), SILBER("Silber", "02"), VERGOLDET("Vergoldet", "03"), VERSILBERT_RHODINIERT("Versilbert/Rhodiniert", "04"), GEMSTONE("Gemstone", "05"), METALLLEGIERUNG_MODESCHMUCK("Metalllegierung / Modeschmuck", "06"), LEDER("Leder", "07"), ROSE_VERGOLDETES_SILBER("Rosé vergoldetes Silber", "08"), CORD("Cord", "09"), GESCHWAERZTES_SILBER("Geschwärztes Silber", "10");
